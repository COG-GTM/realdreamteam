...
test.describe('presence', () => {
  ...
  test.it('touch prunes heartbeats older than 24 hours', () => {
    presence.reset();
    const t0 = 4_000_000;
    presence.touch(1, t0);
    presence.touch(2, t0);
    const day = 24 * 60 * 60 * 1000;
    presence.touch(2, t0 + day + 1000); // re-touch user 2 after a day
    assert.deepEqual(presence.activeHumanIds(day * 10, t0 + day + 2000), [2]);
  });
});
