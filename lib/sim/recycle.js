...
async function cloneForward(rng, { now = new Date(), log = console.log } = {}) {
  return withTransaction(async (client) => {
    ...
    const bank = pickBankLots(seedFiles().lots, liveUrls, lastSeen, rng.int(2, 5));
...
module.exports = { calendarCheck, cloneForward, cleanup, nextHouseRef, driftEstimate, selectSoldLots, pickBankLots, resetRecycler };
