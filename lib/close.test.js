...
test('pickWinner breaks exact ties by lower id', () => {
  const bids = [
    { id: 12, user_id: 1, amount: 500, placed_at: '2026-09-15T10:05:00Z' },
    { id: 7, user_id: 2, amount: 500, placed_at: '2026-09-15T10:05:00Z' }
  ];
  assert.equal(pickWinner(bids).user_id, 2);
});
